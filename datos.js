...
const DATA = {
  ...
  2026: {
    ...
    secretarias: [
      { label: 'Ambiente y Servicios Públicos', val: 45584.66, nota: 'Higiene Urbana + Alumbrado + Serv. Urbanos — Q1×4',
        programas: [
          ...
          { label: 'Administración General (Ambiente)',              val:  1235.61 },
          { label: 'Fort. Cementerio Municipal',                    val:   321.31 },
        ]
      },
      { label: 'Servicio de la Deuda', val: 8429.69, nota: 'Dato Q1 real sin anualizar — incluye pago deuda flotante 2025',
        programas: [
          { label: 'Amortización deuda interna (flotante 2025 + propia)', val: 8429.69 },
        ]
      },
      { label: 'Capital Humano', val: 23995.11, nota: 'SAE + MESA + Infr. Educativa + Deporte + Social + Cultura — Q1×4', nueva25: true,
        programas: [
          { label: 'Administración General (Cap. Humano)',           val:  5737.22 },
      ...
      { label: 'Obras Públicas y Des. Urbano', val: 16025.21, nota: 'Obras Viales + Serv. Generales + Movilidad — Q1×4',
        programas: [
          { label: 'Obras Viales y de Infraestructura',              val: 10796.55 },
          { label: 'Servicios Generales (Obras Púb.)',               val:  2470.53 },
          { label: 'Administración General (Obras Púb.)',             val:   620.62 },
      ...
      { label: 'Secretaría de Salud', val: 12793.00, nota: 'Complejo hospitalario + APS + SAME — Q1×4',
        programas: [
      ...
      { label: 'Secretaría General', val: 6674.70, nota: 'Q1×4',
        programas: [
      ...
      { label: 'Finanzas y Efic. del Estado', val: 6654.34, nota: 'Q1×4',
        programas: [
          { label: 'Administración General (Finanzas)',               val:  1888.55 },
      ...
      { label: 'Trabajo y Producción', val: 4558.25, nota: 'Q1×4',
        programas: [
          { label: 'Plan Anual Seg., Higiene y Ord. Esp. Púb.',     val:  2779.62 },
          { label: 'Administración General (Trabajo)',                val:   803.02 },
          ...
          { label: 'Distrito Innovación y Conocimiento',            val:    26.17 },
          { label: 'Desarrollo Parque Industrial',                   val:    18.10 },
          { label: 'Microcréditos 3F Emprende',                     val:     4.80 },
        ]
      },
      { label: 'Secretaría de Coordinación', val: 3190.65, nota: 'Q1×4',
        programas: [
      ...
      { label: 'H.C.D.', val: 2736.69, nota: 'Q1×4',
        programas: [
          { label: 'Formación y Sanción de las Ordenanzas',         val:  2736.69 },
        ]
      },
      { label: 'Juzgado de Faltas', val: 819.66, nota: 'Q1×4',
        programas: [
          { label: 'Administración General (Juzgado Faltas)',        val:   819.66 },
        ]
      },
    ],
    personal: {
      ...
      paritaria: null,
      porSecretaria: [
        { label: 'Capital Humano',               val:  8512.81 },
        { label: 'Salud',                         val:  8281.35 },
        { label: 'Seguridad',                     val:  7916.25 },
        { label: 'Obras Públicas',                val:  4601.47 },
        { label: 'Trabajo y Producción',          val:  3729.30 },
        { label: 'Ambiente y Serv. Públicos',     val:  3093.75 },
        { label: 'Secretaría General',            val:  2809.99 },
        { label: 'Finanzas y Efic. del Estado',  val:  2627.40 },
        { label: 'Coordinación',                  val:  2471.07 },
        { label: 'HCD',                           val:  1805.72 },
        { label: 'Juzgado de Faltas',             val:   590.62 },
      ],
      componentes: [
        { label: 'Retribuciones del cargo (perm. + temp.)', val: 40713.48 },
        { label: 'Horas extras',                            val:  4437.36 },
        { label: 'DIPREGEP + Asig. familiares + otros',    val:  1288.87 },
      ],
    },
  },
